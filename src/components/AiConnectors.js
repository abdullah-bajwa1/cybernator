...
const AiConnectors = () => {
  ...
  const ObjectInfo = ({ selectedObject }) => {
    ...
    return (
      ...
      <div className="connector-details shadow-box-margin-left" style={{overflowX: "auto"}}>
        ...
        <ProgressBar percent={selectedObject.health} label={selectedObject.name+" Health"} widthOveride="100%" padding={true} />
